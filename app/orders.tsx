...
export default function OrdersScreen() {
  ...
  const getStatusColor = (status: OrderStatus) => {
    switch (status) {
      ...
      case 'on_the_way': return 'text-indigo-600 bg-indigo-100';
  ...
  const statusFilters = [
    ...
    { key: 'on_the_way', label: 'Active', count: mockOrders.filter(o => ['preparing', 'ready', 'on_the_way'].includes(o.status)).length },
        ...
        <View className="px-4 py-4">
          {filteredOrders.map((order) => (
            <Pressable
              ...
              <View className="flex-row items-center justify-between mb-3">
                ...
                <Text className="font-bold text-lg">{formatCurrency(order.total)}</Text>
              </View>
              ...
              {order.status === 'on_the_way' && (
                <View className="bg-blue-50 rounded-lg p-3 mb-3">
                  <View className="flex-row items-center">
                    ...
                    <Text className="ml-2 text-blue-700 font-medium">Arriving in 10-15 minutes</Text>
                  </View>
                </View>
              )}
              ...
              {order.status === 'preparing' && (
                <View className="bg-orange-50 rounded-lg p-3 mb-3">
                  <View className="flex-row items-center">
                    ...
                    <Text className="ml-2 text-orange-700 font-medium">Being prepared</Text>
                  </View>
                </View>
              )}
          ...
          {filteredOrders.length === 0 && (
            <View className="bg-white rounded-xl p-8 items-center">
              ...
              <Text className="text-xl font-semibold mt-4 mb-2">No orders found</Text>
